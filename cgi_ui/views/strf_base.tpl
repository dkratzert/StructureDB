...
<head>
    ...
    <link rel="stylesheet" href="http://{{my_ip}}/static/bootstrap-4.1.3-dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="http://{{my_ip}}/static//strf_web.css">
    <script src="http://{{my_ip}}/static/jquery/jquery-3.3.1.min.js"></script>
    <script src="http://{{my_ip}}/static/bootstrap-4.1.3-dist/js/bootstrap.min.js"></script>
